...
def merge_models(model1, model2, gradient_values, layer_only=False, no_layers=False):
    """
...
def main(args):
    ...
    with torch.no_grad():
        ...
        merge_models(model1, model2, args.gradient_values, args.layer_only, args.no_layers)
